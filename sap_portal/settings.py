"""
Django settings for BHEL SAP Business Processes Portal
"""
...
WSGI_APPLICATION = 'sap_portal.wsgi.application'
...
ADMIN_REGISTRATION_CODE = config('ADMIN_REGISTRATION_CODE', default='BHEL@Admin2025')
